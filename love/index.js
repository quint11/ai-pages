...
var S = {
    init: function () {
      ...
      if (i !== -1) {
        var params = new URLSearchParams(decodeURI(action).substring(i + 1));
        var countdown = params.get('countdown') || '3';
        var text = params.get('text') || 'GJR|520快乐|天天开心|我爱你|';
        S.UI.simulate('|#countdown ' + countdown + '|' + text);
      } else {
        // 默认
        S.UI.simulate('|#countdown 3|GJR|520快乐|天天开心|我爱你|');
      }
  ...
  S.Dot = function (x, y) {
    ...
    this.c = new S.Color(100,149,237,this.p.a);
